...
class AbsensiPascaMubalighController extends Controller
{
  ...
  public function getUsers($id = 0){
    ...
    {
     	$siswaPesantren = DB::table('absensi_pesantren')
		->join('siswa', 'absensi_pesantren.nis', '=', 'siswa.nis')
		->join('kelas', 'kelas.id', '=', 'absensi_pesantren.id_kelas')
		->select('absensi_pesantren.*', 'siswa.nama_siswa' , 'kelas.kode_kelas', 'kelas.nama')
		->get();
   
       return view('admin.absensi.laporanPascaMubaligh',['siswaPesantren'=>$siswaPesantren]);
    }
}
