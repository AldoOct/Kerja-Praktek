...
<section class="content">
 <form class="" method="post" name="form[0]" action="/absensiswasekolah">
    @csrf
    <div class="col-xs-12">
        <div class="box">
...
<!-- /.box-header -->
            <div class="box-body">
                ...
                <tr>
                    ...
                    <th>NIS</th>
                    <th>Nama</th>
                    <th><input type="checkbox" name="allbox" value="nis" onclick="checkAll(0);" /> Pilih Semua</th>
                </tr>
                </thead>
           ...
           if(len > 0){
             for(var i=0; i<len; i++){
               ...
               var tr_str = "<tr>" +
                   ...
                   "<td>" + nis + "</td>" +
                   "<td>" + nama_siswa + "</td>" +
                   "<td><center><input type = 'checkbox' name = 'nis[]' value = '"+getid[i]+"'/><center></td>"+
               "</tr>";
