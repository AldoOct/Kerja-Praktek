...
<section class="content">
    <form class="" method="post" name="form[0]" action="/absenguru">
    @csrf
    <div class="col-xs-12">
        <div class="box">
...
<!-- /.box-header -->
            <div class="box-body">
                ...
                <tr>
                    ...
                    <th>NIP</th>
                    <th>Nama</th>
                    <th><input type="checkbox" name="allbox" value="nip" onclick="checkAll(0);" /> Pilih Semua</th>
                </tr>
                </thead>
                ...
                <?php $getid[$nomer] = $row->nip; ?>
                    ...
                    <td>{{$row->nip}}</td>
                    <td>{{$row->nama}}</td>
                    <td><center><input type = "checkbox" name = "nip[]" value = "{{$getid[$nomer]}}"/></center></td>
                <?php $nomer++; ?>
                </tr>
                @endforeach
                </tbody>
