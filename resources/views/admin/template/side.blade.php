...
<section class="sidebar">
   ...
   <!--  <li class="">
    ...
    <li class="treeview">
        ...
        <li><a href="/absenbimbel/LaporanBimbel"><i class="fa fa-circle-o"></i> Bimbel</a></li>
        <li><a href="/absenpascamubaligh/LaporanPascaMubaligh"><i class="fa fa-circle-o"></i> Pesantren </a></li>
